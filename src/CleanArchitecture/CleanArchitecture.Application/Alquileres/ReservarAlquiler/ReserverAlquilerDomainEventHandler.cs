...
internal sealed class ReserverAlquilerDomainEventHandler
: INotificationHandler<AlquilerReservadoDomainEvent>
{
    private readonly IAlquilerRepository _alquilerRepository;
    private readonly IUserRepository _userRepository;
    private readonly IEmailService _emailService;
public ReserverAlquilerDomainEventHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        .GetByIdAscync(notification.AlquilerId, cancellationToken);
